#include <SoftwareSerial.h>                         //SoftwareSerial library to use the pin no. 2,3 as Rx, Tx.      
SoftwareSerial esp8266(2,3);                        // Rx ==> Pin 2; TX ==> Pin3.      
#define serialCommunicationSpeed 9600               // baud rate 9600   
#define DEBUG true                                  //make a constant named "DEBUG" and it's value true. we will use it later.      
int redLED =11;                                     //pin which the red LED is connected on.      
int blueLED =12;                                    //pin which the blue LED is connected on.      
void setup()      
{      
  pinMode(redLED,OUTPUT);                           //pin number 12 as an output pin.      
  pinMode(blueLED,OUTPUT);                          //pin number 11 as an output pin.      
  ...
  InitWifiModule();                                 //communication between the ESP8266 and web server
}   
...
/******************************************************************************************************************************************************************************************          
*This Function regulates how the AT Commands will be sent to the ESP8266.      
*/      
...
{      
  ...
  delay(1000);      
  sendData("AT+CWJAP=\"WIFI_NAME\",\"WIFIPASSWORD\"\r\n", 2000, DEBUG);        //connect to the WiFi network.      
  delay (3000);      
